#!/usr/bin/env bash
# adwords - Content creation and optimization assistant
set -euo pipefail
VERSION="2.0.0"
DATA_DIR="${ADWORDS_DIR:-${XDG_DATA_HOME:-$HOME/.local/share}/adwords}"
...
case "${1:-help}" in
    ...
    help|-h) show_help ;;
    version|-v) echo "adwords v$VERSION" ;;
