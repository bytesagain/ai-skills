...
description: "Generate PPT with Baidu AI. Smart template selection based on content. Use when you need ai ppt generator capabilities. Triggers on: ai ppt generator."
---
...
```json
{
  "status": "PPT导出结束", 
  "is_end": true, 
  "data": {"ppt_url": "[configured-endpoint]
}
```
