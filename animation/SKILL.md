...
tags: [animation, general, cli, tool]
category: "general"
---
...
|----------|----------|-------------|
| `ANIMATION_DIR` | No | Data directory (default: ~/.animation/) |

## Data Storage

All data stored in `~/.animation/` using JSONL format (one JSON object per line).
