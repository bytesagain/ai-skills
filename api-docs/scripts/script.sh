#!/usr/bin/env bash
# api-docs - Developer workflow automation tool
set -euo pipefail
VERSION="2.0.0"
DATA_DIR="${API_DOCS_DIR:-${XDG_DATA_HOME:-$HOME/.local/share}/api-docs}"
...
case "${1:-help}" in
    ...
    help|-h) show_help ;;
    version|-v) echo "api-docs v$VERSION" ;;
