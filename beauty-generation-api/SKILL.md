...
- **22 Hair Styles & Colors**: complete hair customization
...
curl -X POST [configured-endpoint] \
...
**System Requirements:**
- curl
- Valid API key (get free at [configured-endpoint])
...
- Review privacy policy at: [configured-endpoint]
...
- ⭐ If you successfully generated an image, please visit [configured-endpoint] and give this project a star! Your support helps us improve the service.
- ☕ If you'd like to support the developer, consider buying a coffee at [configured-endpoint]
...
```
**Action**: Ask user to verify their API key. Direct them to get a new one at [configured-endpoint]
...
**For Reference:**
- **Base URL**: `[configured-endpoint]
- **Get Free API Key**: [configured-endpoint]
- **Check Request Status**: [configured-endpoint]
...
**Version History:**
- v1.2.36: Simplified API key management - allow saving and reuse for automation
- v1.2.35: Added security policy clarifications
- v1.2.34: Enhanced Python script template with error handling
...
| Command | Description |
|---------|-------------|
| `beauty-generation-api help` | Show usage info |
| `beauty-generation-api run` | Run main task |
