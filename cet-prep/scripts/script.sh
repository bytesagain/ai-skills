#!/usr/bin/env bash
# cet-prep - Multi-purpose utility tool
set -euo pipefail
VERSION="2.0.0"
DATA_DIR="${CET_PREP_DIR:-${XDG_DATA_HOME:-$HOME/.local/share}/cet-prep}"
...
case "${1:-help}" in
    ...
    info) shift; cmd_info "$@" ;;
    help|-h) show_help ;;
    version|-v) echo "cet-prep v$VERSION" ;;
