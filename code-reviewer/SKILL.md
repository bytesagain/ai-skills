...
version: "2.0.0"
name: code-reviewer
description: "代码审查、重构建议、安全漏洞检查、命名规范、复杂度分析、注释文档生成. Use when you need code reviewer capabilities. Triggers on: code reviewer."
---
...
| Command | Description |
|---------|-------------|
| `code-reviewer help` | Show usage info |
| `code-reviewer run` | Run main task |
