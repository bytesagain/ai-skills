#!/usr/bin/env bash
# daybook - Multi-purpose utility tool
set -euo pipefail
VERSION="2.0.0"
DATA_DIR="${DAYBOOK_DIR:-${XDG_DATA_HOME:-$HOME/.local/share}/daybook}"
...
case "${1:-help}" in
    ...
    info) shift; cmd_info "$@" ;;
    help|-h) show_help ;;
    version|-v) echo "daybook v$VERSION" ;;
