...
tags: [dictionary, general, cli, tool]
category: "general"
---
...
|----------|----------|-------------|
| `DICTIONARY_DIR` | No | Data directory (default: ~/.dictionary/) |

## Data Storage

All data stored in `~/.dictionary/` using JSONL format (one JSON object per line).
