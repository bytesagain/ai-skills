#!/usr/bin/env bash
# foam — Foam reference tool. Use when working with foam in life contexts.
...
show_help() {
    cat << 'HELPEOF'
foam v$VERSION — Foam Reference Tool
...
## What is Foam?
Foam (foam) is a specialized tool/concept in the life domain.
It provides essential capabilities for professionals working with foam.

## Key Concepts
- Core foam principles and fundamentals
- How foam fits into the broader life ecosystem  
- Essential terminology every practitioner should know

## Why Foam Matters
Understanding foam is critical for:
...
## Getting Started
1. Understand the basic foam concepts
...
cmd_guide() {
    cat << 'EOF'
# Foam — Step-by-Step Guide

## Overview
This guide walks you through the essential foam workflows.
...
cmd_examples() {
    cat << 'EOF'
# Foam — Real-World Examples

## Example 1: Basic Setup
A typical foam setup for a small team:
- Standard configuration with defaults
- Basic monitoring enabled
- Manual backup schedule

## Example 2: Production Deployment
An enterprise foam deployment:
...
cmd_faq() {
    cat << 'EOF'
# Foam — Frequently Asked Questions

## General
**Q: What is Foam?**
A: Foam is a reference tool for foam in the life domain.

**Q: Who should use this?**
A: Anyone working with foam who needs quick reference material.
...
case "$CMD" in
    ...
    version|--version|-v) echo "foam v$VERSION — Powered by BytesAgain" ;;
    *) echo "Unknown: $CMD"; echo "Run: foam help"; exit 1 ;;
esac
