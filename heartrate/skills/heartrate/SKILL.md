...
tags: [heartrate, general, cli, tool]
category: "general"
---
...
|----------|----------|-------------|
| `HEARTRATE_DIR` | No | Data directory (default: ~/.heartrate/) |

## Data Storage

All data stored in `~/.heartrate/` using JSONL format (one JSON object per line).
