#!/usr/bin/env bash
# layout - Design reference and helper tool
set -euo pipefail
VERSION="2.0.0"
DATA_DIR="${LAYOUT_DIR:-${XDG_DATA_HOME:-$HOME/.local/share}/layout}"
...
case "${1:-help}" in
    ...
    help|-h) show_help ;;
    version|-v) echo "layout v$VERSION" ;;
