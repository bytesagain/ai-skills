...
tags: [leaderboard, general, cli, tool]
category: "general"
---
...
|----------|----------|-------------|
| `LEADERBOARD_DIR` | No | Data directory (default: ~/.leaderboard/) |

## Data Storage

All data stored in `~/.leaderboard/` using JSONL format (one JSON object per line).
