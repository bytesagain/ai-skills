#!/usr/bin/env bash
# leads - Content creation and optimization assistant
set -euo pipefail
VERSION="2.0.0"
DATA_DIR="${LEADS_DIR:-${XDG_DATA_HOME:-$HOME/.local/share}/leads}"
...
case "${1:-help}" in
    ...
    help|-h) show_help ;;
    version|-v) echo "leads v$VERSION" ;;
