#!/usr/bin/env bash
# my-agent - AI and prompt engineering assistant
set -euo pipefail
VERSION="2.0.0"
DATA_DIR="${MY_AGENT_DIR:-${XDG_DATA_HOME:-$HOME/.local/share}/my-agent}"
...
case "${1:-help}" in
    ...
    help|-h) show_help ;;
    version|-v) echo "my-agent v$VERSION" ;;
