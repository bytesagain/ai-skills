...
tags: [notification, general, cli, tool]
category: "general"
---
...
|----------|----------|-------------|
| `NOTIFICATION_DIR` | No | Data directory (default: ~/.notification/) |

## Data Storage

All data stored in `~/.notification/` using JSONL format (one JSON object per line).
