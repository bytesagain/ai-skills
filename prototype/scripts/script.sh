#!/usr/bin/env bash
# prototype - Design reference and helper tool
set -euo pipefail
VERSION="2.0.0"
DATA_DIR="${PROTOTYPE_DIR:-${XDG_DATA_HOME:-$HOME/.local/share}/prototype}"
...
case "${1:-help}" in
    ...
    help|-h) show_help ;;
    version|-v) echo "prototype v$VERSION" ;;
