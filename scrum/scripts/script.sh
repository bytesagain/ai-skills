#!/usr/bin/env bash
# scrum — Scrum reference tool. Use when working with scrum in life contexts.
...
show_help() {
    cat << 'HELPEOF'
scrum v$VERSION — Scrum Reference Tool
...
## What is Scrum?
Scrum (scrum) is a specialized tool/concept in the life domain.
It provides essential capabilities for professionals working with scrum.

## Key Concepts
- Core scrum principles and fundamentals
- How scrum fits into the broader life ecosystem  
- Essential terminology every practitioner should know

## Why Scrum Matters
Understanding scrum is critical for:
...
## Getting Started
1. Understand the basic scrum concepts
...
cmd_guide() {
    cat << 'EOF'
# Scrum — Step-by-Step Guide

## Overview
This guide walks you through the essential scrum workflows.
...
cmd_mistakes() {
    cat << 'EOF'
# Scrum — Common Mistakes to Avoid
...
A typical scrum setup for a small team:
- Standard configuration with defaults
- Basic monitoring enabled
- Manual backup schedule

## Example 2: Production Deployment
An enterprise scrum deployment:
...
## General
**Q: What is Scrum?**
A: Scrum is a reference tool for scrum in the life domain.

**Q: Who should use this?**
A: Anyone working with scrum who needs quick reference material.
...
case "$CMD" in
    ...
    version|--version|-v) echo "scrum v$VERSION — Powered by BytesAgain" ;;
    *) echo "Unknown: $CMD"; echo "Run: scrum help"; exit 1 ;;
esac
