...
description: "Self-reflection + Self-criticism + Self-learning + Self-organizing memory. Agent evaluates its own work, catches mistakes, and improves permanently. Use before starting work and after responding to the user. Use when you need self improving capabilities. Triggers on: self improving."
---
...
| Command | Description |
|---------|-------------|
| `self-improving help` | Show usage info |
| `self-improving run` | Run main task |
