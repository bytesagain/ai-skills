#!/usr/bin/env bash
# spaced-repetition — Spaced Repetition reference tool. Use when working with spaced repetition in life contexts.
...
show_help() {
    cat << 'HELPEOF'
spaced-repetition v$VERSION — Spaced Repetition Reference Tool

Usage: spaced-repetition <command>
...
Spaced Repetition (spaced-repetition) is a specialized tool/concept in the life domain.
It provides essential capabilities for professionals working with spaced repetition.

## Key Concepts
- Core spaced repetition principles and fundamentals
- How spaced repetition fits into the broader life ecosystem  
- Essential terminology every practitioner should know

## Why Spaced Repetition Matters
Understanding spaced repetition is critical for:
...
## Getting Started
1. Understand the basic spaced repetition concepts
...
cmd_guide() {
    cat << 'EOF'
# Spaced Repetition — Step-by-Step Guide

## Overview
This guide walks you through the essential spaced repetition workflows.
...
cmd_tips() {
    cat << 'EOF'
# Spaced Repetition — Pro Tips & Tricks
...
cmd_planning() {
    cat << 'EOF'
# Spaced Repetition — Planning & Preparation
...
cmd_resources() {
    cat << 'EOF'
# Spaced Repetition — Recommended Resources
...
cmd_mistakes() {
    cat << 'EOF'
# Spaced Repetition — Common Mistakes to Avoid
...
cmd_examples() {
    cat << 'EOF'
# Spaced Repetition — Real-World Examples

## Example 1: Basic Setup
A typical spaced repetition setup for a small team:
- Standard configuration with defaults
- Basic monitoring enabled
- Manual backup schedule

## Example 2: Production Deployment
An enterprise spaced repetition deployment:
...
A: Spaced Repetition is a reference tool for spaced repetition in the life domain.

**Q: Who should use this?**
A: Anyone working with spaced repetition who needs quick reference material.
...
case "$CMD" in
    ...
    version|--version|-v) echo "spaced-repetition v$VERSION — Powered by BytesAgain" ;;
    *) echo "Unknown: $CMD"; echo "Run: spaced-repetition help"; exit 1 ;;
esac
