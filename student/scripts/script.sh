#!/usr/bin/env bash
# student - Learning and study assistant
set -euo pipefail
VERSION="2.0.0"
DATA_DIR="${STUDENT_DIR:-${XDG_DATA_HOME:-$HOME/.local/share}/student}"
...
case "${1:-help}" in
    ...
    test) shift; cmd_test "$@" ;;
    help|-h) show_help ;;
    version|-v) echo "student v$VERSION" ;;
