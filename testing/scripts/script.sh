#!/usr/bin/env bash
# testing - Multi-purpose utility tool
set -euo pipefail
VERSION="2.0.0"
DATA_DIR="${TESTING_DIR:-${XDG_DATA_HOME:-$HOME/.local/share}/testing}"
...
case "${1:-help}" in
    ...
    info) shift; cmd_info "$@" ;;
    help|-h) show_help ;;
    version|-v) echo "testing v$VERSION" ;;
