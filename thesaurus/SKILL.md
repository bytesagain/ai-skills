...
tags: [thesaurus, general, cli, tool]
category: "general"
---
...
|----------|----------|-------------|
| `THESAURUS_DIR` | No | Data directory (default: ~/.thesaurus/) |

## Data Storage

All data stored in `~/.thesaurus/` using JSONL format (one JSON object per line).
