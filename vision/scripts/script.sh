#!/usr/bin/env bash
# vision - AI and prompt engineering assistant
set -euo pipefail
VERSION="2.0.0"
DATA_DIR="${VISION_DIR:-${XDG_DATA_HOME:-$HOME/.local/share}/vision}"
...
case "${1:-help}" in
    ...
    help|-h) show_help ;;
    version|-v) echo "vision v$VERSION" ;;
