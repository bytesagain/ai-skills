...
description: ">. Use when you need xiaohongshu mcp capabilities. Triggers on: xiaohongshu mcp."
...
**Project:** [xpzouying/xiaohongshu-mcp](https://)
...
Download the appropriate binaries for your system from the [GitHub Releases](https://) page.
...
The server will be available at `[configured-endpoint]
...
| Command | Description |
|---------|-------------|
| `xiaohongshu-mcp help` | Show usage info |
| `xiaohongshu-mcp run` | Run main task |
